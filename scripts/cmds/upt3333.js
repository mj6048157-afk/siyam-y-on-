...
module.exports = {
    config: {
        name: "up",
        aliases: ["uptime", "status", "dashboard"],
        version: "9.5.0",
        author: "SIYAM_HASAN",
        countDown: 5,
        role: 0,
    ...
    onStart: async function ({ message, api, event }) {
        ...
        const loadingMessage = await message.reply("⚙️ Connecting to Cyber Core System... Please wait...");
        ...
        try {
            ...
            // আপনার দেওয়া নতুন ইমেজ লিঙ্কটি এখানে বসানো হয়েছে
            const cyberEagleImageUrl = "https://files.catbox.moe/vnhyqa.jpg";
